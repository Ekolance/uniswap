...
contract Liquidity is IERC721Receiver {
    ...
    function mintNewPosition(uint amount0ToMint, uint amount1ToMint, int24 a, int24 b)
        external
        returns (
            uint256 tokenId,
            uint128 liquidity,
        ...
        )
    {
        ...
        deposits[tokenId] = Deposit({owner: msg.sender, liquidity: liquidity, token0: DAI, token1: USDC});
